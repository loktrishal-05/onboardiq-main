...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const data = await api.auth.login(form) as { token: string; user: Parameters<typeof setAuth>[0] };
      ...
      <div className="relative z-10 w-full max-w-md animate-slide-up">
        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <div className="mt-4 p-3 rounded-xl bg-gold/5 border border-gold/20 text-xs text-gold/80">
            <strong>Demo:</strong> Create an account to generate your personalized AI onboarding plan.
          </div>
